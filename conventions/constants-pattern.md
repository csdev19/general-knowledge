...
_Type-safe, single-source-of-truth pattern for enum-like values._
...
import type { Currency } from "@your-scope/domain/constants";
...
import { CURRENCIES, CURRENCY_INFO } from "@your-scope/domain/constants";
...
import { isValidCurrency } from "@your-scope/domain/constants";
...
```typescript
// ✅ Good: Using constants in an API contract (Zod)
import { z } from "zod";
import { CURRENCIES } from "@your-scope/domain/constants";
...
import { z } from "zod";
import { COMMENT_TYPES } from "@your-scope/domain/constants";
...
### Entity Status (`packages/domain/src/constants/your-entity-status.ts`)
...
```typescript
import { YOUR_ENTITY_STATUS_INFO } from "@your-scope/domain/constants";
import type { YourEntityStatus } from "@your-scope/domain/constants";
...
4. **Export from domain package**
   ...
   ```typescript
   // ✅ Good: Export from @your-scope/domain/constants
