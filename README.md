...
| [desktop/](./desktop/)               | Electron and Tauri. Electron: main/renderer/preload, IPC tipado, permisos nativos, vault local-first, media pipeline, **dependencias nativas (rebuild explícito, nunca `postinstall`)**, **speech-to-text local (sidecars obligatorios, la compuerta de voz no es portable entre motores, disciplina de benchmark con hashes de modelo)**, distribución. Tauri: webview vs Rust core placement of business logic                                                                                                                                                                                    |
