...
| [desktop/](./desktop/)               | Electron and Tauri. Electron: main/renderer/preload, IPC tipado, permisos nativos, vault local-first, media pipeline, **dependencias nativas (rebuild explícito, nunca `postinstall`)**, distribución. Tauri: webview vs Rust core placement of business logic                                                                                                                                                                                    |
...
| [desktop-tauri](./stacks/desktop-tauri.md)                 | Lightweight local-first Tauri desktop app                                         |
