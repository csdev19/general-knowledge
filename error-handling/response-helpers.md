...
_Helper functions for creating standardized API responses._
...
.get("/:id", async ({ params, status }) => {
  ...
  return status(200, successBody(entity));
})
```
...
- [API Response Types](./api-response-types.md) — Response structure documentation
- [Error Handlers](./error-handlers.md) — Error handling utilities
